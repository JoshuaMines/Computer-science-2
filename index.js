...
// ANSWER: We don't know the length of the string in either situation so both would be O(n)
...
console.log(noCacheCalFalc(2))
console.log(noCacheCalFalc(4))
console.log(noCacheCalFalc(5))
console.log(noCacheCalFalc(1))
console.timeEnd("not memoized factorial");

console.time("memoized factorial");
console.log(myFac.calcFac(2))
console.log(myFac.calcFac(4))
console.log(myFac.calcFac(3))
console.log(myFac.calcFac(3))
